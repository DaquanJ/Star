...
class MyHoroscopes extends Component {
    ...
    componentDidMount = async () => {
        try {
            const response = await axios.get('https://cors-anywhere.herokuapp.com/https://myzodiac.herokuapp.com/horoscopes');
    ...
    deleteHoroscopes = async (id) => {
        ...
        try {
            const deleted = await axios.delete(`https://cors-anywhere.herokuapp.com/https://myzodiac.herokuapp.com/horoscopes/${id}`, savedHoroscopes)
